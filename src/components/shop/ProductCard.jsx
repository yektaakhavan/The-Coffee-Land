  ...
  return (
    <div className="group relative rounded-[30px] p-[1px] bg-gradient-to-br from-white/70 via-amber-100/40 to-orange-200/30">
      ...
      <div
        ...
        group-hover:shadow-[0_20px_45px_rgba(120,53,15,0.18)]
        transition
        duration-500
      "
      >
        ...
        >
          ...
          {discountPercent > 0 && (
            ...
            "
            >
              <Badge type="discount">%{discountPercent}</Badge>
            </div>
          )}
  ...
  "
          ...
          <Link
            ...
            className="
              ...
              text-center
              tracking-wide
              shadow-[0_8px_20px_rgba(120,53,15,0.25)]
              hover:shadow-[0_12px_25px_rgba(120,53,15,0.35)]
              hover:scale-[1.02]
              transition
              duration-300
            "
